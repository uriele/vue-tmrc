...
export const SURVEYRESULTLINK: DownloadLink = {
  label: 'TMRC 2026 Survey Results',
  url: '/downloads/TMRC_2026_Survey_Results.pdf',
  filename: 'TMRC_2026_Survey_Results.pdf'
}
...
export const NAVLINKS: NavLinks = [
  ...
  { label: 'Important Dates', to: { name: 'deadlines' } },
  { group: 'Program',
    links: [
...
export const POSTERPRESENTATION: Array<InvitedSpeaker> = [
{id:1,groupId:'P1',paperId:1,name:'T. Coughlin',affiliation:'Coughlin Associates', title:'2026 IEEE mass storage roadmap',
  date:Temporal.ZonedDateTime.from('2026-08-03T17:30:00-07:00[America/Los_Angeles]')},
{id:2,groupId:'P1',paperId:2,title:'Dual-layer HAMR media with Ir intermediate layer for multi-level magnetic recording',name:'J. Chang',affiliation:'Carnegie Mellon University',
  date:Temporal.ZonedDateTime.from('2026-08-03T17:00:00-07:00[America/Los_Angeles]')},
{id:3,groupId:'P1',paperId:3,title:'Plasmonic nanoantennas for helicity-dependent all-optical switching',name:'T. E. McCormack',affiliation:'Queen’s University',
  date:Temporal.ZonedDateTime.from('2026-08-03T17:00:00-07:00[America/Los_Angeles]')},
{id:4,groupId:'P1',paperId:4,title:'Multilayered magnetic recording media enabled by a Pt1-xTax intermediate layer',name:'B. L. Reese',affiliation:'Carnegia Mellon University',
  date:Temporal.ZonedDateTime.from('2026-08-03T17:00:00-07:00[America/Los_Angeles]')},
{id:5,groupId:'P1',paperId:5,title:'Nd-induced enhancement of magnetic damping in L10-FePt for HAMR',name:'A. Sakoguchi',affiliation:'Western Digital Corporation',
  date:Temporal.ZonedDateTime.from('2026-08-03T17:00:00-07:00[America/Los_Angeles]')},
{id:6,groupId:'P1',paperId:6,title:'Grain size refinement of FePt granular films by introducing AlN-C and NbN-C as grain boundary materials for HAMR media',name:'K. K. Tham',affiliation:'Tanaka Precious Metals',
  date:Temporal.ZonedDateTime.from('2026-08-03T17:00:00-07:00[America/Los_Angeles]')},
{id:7,groupId:'P1',paperId:7,title:'Efficient media heating through optical energy-flow control via NFT and spacing design in HAMR',name:'R. Osamura',affiliation:'Toshiba Corporation',
  date:Temporal.ZonedDateTime.from('2026-08-03T17:00:00-07:00[America/Los_Angeles]')},
{id:8,groupId:'P1',paperId:8,title:'Dip-coating of a nanometer-thick fluorinated imidazolium ionic liquid: adsorption kinetics, capillarity, and drainage in dual-layer film formation',name:'A. Dahiru',affiliation:'University of Pittsburgh',
  date:Temporal.ZonedDateTime.from('2026-08-03T17:00:00-07:00[America/Los_Angeles]')},
{id:9,groupId:'P1',paperId:9,title:'Fabrication and characterization of nanometer-thick PDMS films for hard disk drives',name:'F. Almanea',affiliation:'University of Pittsburgh',
  date:Temporal.ZonedDateTime.from('2026-08-03T17:00:00-07:00[America/Los_Angeles]')},
{id:10,groupId:'P1',paperId:10,title:'Synthetic ferrimagnetic free layer for quasi-differential HDD reader',name:'Y. Nakagawa',affiliation:'Toshiba Corporation',
  date:Temporal.ZonedDateTime.from('2026-08-03T17:00:00-07:00[America/Los_Angeles]')},
{id:11,groupId:'P1',paperId:11,title:'Comparison between vector recording and TDMR: inter-track interference, and write synchronization effects',name:'K. Hosen',affiliation:'University of Minnesota',
  date:Temporal.ZonedDateTime.from('2026-08-03T17:00:00-07:00[America/Los_Angeles]')},
{id:12,groupId:'P1',paperId:12,title:'Scanning magnetoresistance microscopy of tape writers and media',name:'S. Furrer',affiliation:'IBM Research Europe',
  date:Temporal.ZonedDateTime.from('2026-08-03T17:00:00-07:00[America/Los_Angeles]')},
{id:13,groupId:'P1',paperId:13,title:'Strong interlayer coupling accompanying order suppression in La2/3Sr1/3MnO3 / La1/3Sr2/3FeO3 heterostructures',name:'K. Matthews',affiliation:'UCSD',
  date:Temporal.ZonedDateTime.from('2026-08-03T18:30:00-07:00[America/Los_Angeles]')},
{id:14,groupId:'P2',paperId:1,
  title:'A media-optimized iterative detection scheme for dual-layer staggered BPMR systems',
  name:'P. Lerdsrisuwattana',affiliation:'King Mongkut’s Institute of Technology Ladkrabang',
  date:Temporal.ZonedDateTime.from('2026-08-04T17:30:00-07:00[America/Los_Angeles]')},
{id:15,groupId:'P2',paperId:2,
  title:'Enhanced signal processing for single-reader/dual-track reading (SRDR) bit-patterned magnetic recording systems',
  name:'N. Rueangnetr',affiliation:'King Mongkut’s Institute of Technology Ladkrabang',
  date:Temporal.ZonedDateTime.from('2026-08-04T17:30:00-07:00[America/Los_Angeles]')},
{id:16,groupId:'P2',paperId:3,
  title:'Maximizing areal-density: a frequency domain perspective	',
  name:'R. Wood',affiliation:'Western Digital Corporation',
  date:Temporal.ZonedDateTime.from('2026-08-04T17:30:00-07:00[America/Los_Angeles]')},
{id:17,groupId:'P2',paperId:4,
  title:'Signal processing technique for three-level magnetic recording',
  name:'R. Charoenying',affiliation:'King Mongkut’s Institute of Technology Ladkrabang',
  date:Temporal.ZonedDateTime.from('2026-08-04T17:30:00-07:00[America/Los_Angeles]')},
{id:18,groupId:'P2',paperId:5,
  title:'Unequal recording-layer thickness with readback signal rescaling and MLP detection in dual-layer BPMR systems',
  name:'S. Tor.Wattanaphol',affiliation:'King Mongkut’s Institute of Technology Ladkrabang',
  date:Temporal.ZonedDateTime.from('2026-08-04T17:30:00-07:00[America/Los_Angeles]')},
{id:19,groupId:'P2',paperId:6,
  title:'Low-complexity CNN detection and readhead optimization in dual-reader shingled magnetic recording systems',
  name:'E. Anantawilailaka',affiliation:'King Mongkut’s Institute of Technology Ladkrabang',
  date:Temporal.ZonedDateTime.from('2026-08-04T17:30:00-07:00[America/Los_Angeles]')},
...
{id:21,groupId:'P2',paperId:8,
  ...
  name:'Y. Matsumoto',affiliation:'University of Osaka',
  date:Temporal.ZonedDateTime.from('2026-08-04T17:30:00-07:00[America/Los_Angeles]')},
{id:22,groupId:'P2',paperId:9,
  title:'Implementation of antiferromagnetic barrier with high tunneling magnetoresistance: a pathway toward magnon-assisted spin-transfer torque switching',
  name:'A. Habiboglu',affiliation:'University of Arizona',
  date:Temporal.ZonedDateTime.from('2026-08-04T17:30:00-07:00[America/Los_Angeles]')},
{id:23,groupId:'P2',paperId:10,
  title:'Interface orbital magnetism in Ti/Ni and Cr/Ni bilayers relevant to spin–orbit-torque materials',
  name:'P. Zhang',affiliation:'Hubei University of Technology',
  date:Temporal.ZonedDateTime.from('2026-08-04T17:30:00-07:00[America/Los_Angeles]')},
{id:24,groupId:'P2',paperId:11,
  title:'A reliable and compact STT-MRAM based digital look-up table CiM',
  name:'Y. Wang',affiliation:'Tohoku University',
  date:Temporal.ZonedDateTime.from('2026-08-04T17:30:00-07:00[America/Los_Angeles]')},
{id:25,groupId:'P2',paperId:12,
  title:'Electronic structure and magnetic compensation in Te-capped Mn–Te thin films probed by XMCD',
  name:'J. Lu',affiliation:'Hubei University of Technology',
  date:Temporal.ZonedDateTime.from('2026-08-04T17:30:00-07:00[America/Los_Angeles]')},
{id:26,groupId:'P2',paperId:13,
  title:'Domain wall memories with reconfigurable pinning by magnetic topological insulator',
  name:'A. Hoque',affiliation:'University of South Florida',
  date:Temporal.ZonedDateTime.from('2026-08-04T18:45:00-07:00[America/Los_Angeles]')}
]
...
{groupId: 'A',paperId:6,
   date: Temporal.ZonedDateTime.from('2026-08-03T11:20:00-07:00[America/Los_Angeles]'),
   name: 'Yukiko Takahashi', affiliation: 'NIMS',
   title: 'ML-Assisted Optimization for FePt granular films', id: 7, len: 25},
...
{groupId: 'B',
  paperId:1,
  date: Temporal.ZonedDateTime.from('2026-08-03T13:15:00-07:00[America/Los_Angeles]'),
  name: 'Takuya Matsumoto',
  affiliation: 'WD',
  title: 'Near-field transducer design for >4Tb/in²', id: 24, len: 25},
...
{groupId: 'C',paperId:1,
  date: Temporal.ZonedDateTime.from('2026-08-04T09:00:00-07:00[America/Los_Angeles]'),
  name: 'Hiroyasu Nakayama',
  affiliation: 'AIST',
  title: 'Highly reliable voltage-induced static magnetization switching for voltage-controlled MRAM', id: 33, len: 25},
...
{groupId: 'C',paperId:3,
  date: Temporal.ZonedDateTime.from('2026-08-04T09:50:00-07:00[America/Los_Angeles]'),
   name: 'Fred Mancoff',
   affiliation: 'Everspin',
   title: '125°C Capable Standalone STT-MRAM for High Reliability Applications', id: 37, len: 25},
...
{groupId: 'D',paperId:3,
  date: Temporal.ZonedDateTime.from('2026-08-04T14:05:00-07:00[America/Los_Angeles]'), name: 'Tatsuya Kishi', affiliation: 'Topologic Inc.',
  //title: 'Development of ultra-high-speed TL-RAM (Topological MRAM) using novel topological materials',
  title: 'CMOS-compatible 512kb SOT-MRAM with Topological Material',
  id: 38, len: 25},
...
{groupId: 'E',paperId:2,
  date: Temporal.ZonedDateTime.from('2026-08-05T08:25:00-07:00[America/Los_Angeles]'),
  name: 'Joseph S. Friedman', affiliation: 'The University of Texas at Dallas', title: 'Neuromorphic Hebbian learning with magnetic tunnel junction synapses', id: 15, len: 25},
...
{groupId: 'E',paperId:6,
  date: Temporal.ZonedDateTime.from('2026-08-05T10:20:00-07:00[America/Los_Angeles]'), name: 'Mehdi Saligane',
  affiliation: 'Brown University',
  title: 'Rethinking chip designs in the age of AI', id: 14, len: 25},
...
export const WORKSHOPSPEAKER: InvitedSpeaker[] = [
  {
    ...
    paperId: -1,
    date: Temporal.ZonedDateTime.from('2026-08-02T15:30:00-07:00[America/Los_Angeles]'),
  },
  {
    name: 'Soo Kim',
    affiliation: 'IEEE',
    ...
    groupId: 'Standards in Magnetics Workshop',
    paperId: 0,
    date: Temporal.ZonedDateTime.from('2026-08-02T15:35:00-07:00[America/Los_Angeles]'),
  },
  {
  name: 'Sergio Montoya',
  affiliation: 'UCSD',
  ...
  groupId: 'Standards in Magnetics Workshop',
  paperId: 1,
  date: Temporal.ZonedDateTime.from('2026-08-02T15:45:00-07:00[America/Los_Angeles]'),
},
{ name: 'David Logue',
  affiliation: 'Ontrack',
  ...
  groupId: 'Standards in Magnetics Workshop',
  paperId: 2,
  date: Temporal.ZonedDateTime.from('2026-08-02T16:10:00-07:00[America/Los_Angeles]'),
},
...
{ name: 'Daniel Gopman',
  ...
  groupId: 'Standards in Magnetics Workshop',
  paperId: 4,
  date: Temporal.ZonedDateTime.from('2026-08-02T17:20:00-07:00[America/Los_Angeles]'),
},
{ name: 'Mircea Stan',
  ...
  groupId: 'Standards in Magnetics Workshop',
  paperId: 5,
  date: Temporal.ZonedDateTime.from('2026-08-02T17:45:00-07:00[America/Los_Angeles]'),
}
]
