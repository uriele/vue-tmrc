...
const roleTypes: RoleTypes[] = ['Conference Chair','Program Co-Chair', 'Poster Co-Chair', 'Local Co-Chair', 'Publication Co-Chair', 'Publicity Co-Chair', 'Treasurer', 'Technical Chair','Event Coordinator']
