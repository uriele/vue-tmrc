...
import { INSTRUCTIONSLINKS } from '@/router/routerConstants';
...
{link: ()=> new URL('https://ieee.atyponrex.com/journal/magconf-ieee'),
 downloads: ()=> INSTRUCTIONSLINKS
}
)
</script>
...
<template>
  ...
  <section class="main p-4">
    ...
    <div class="d-flex justify-content-center align-items-center gap-4 p-2 lead">
