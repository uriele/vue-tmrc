...
const primaryColor= '#182b49';
const secondaryColor= '#ffcd00';
...
<template>
  <section class="main p-4 d-flex flex-row flex-wrap-reverse justify-content-between">
    <div class="main-text m-4">
      <slot />
    </div>
    <div class="main-map flex-fill m-4">
    <GoogleMap
      :api-key="apiKey"
      :map-id="mapID"
      :center="centerUCSD"
    ...
    >
      <AdvancedMarker
        ...
        :pin-options="{ background: primaryColor, borderColor: primaryColor,
           glyphColor: secondaryColor,glyphSrc: marker.src
           ,scale: 1.5 }"
      >
      </AdvancedMarker>
